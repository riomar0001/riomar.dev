      ...
      <div className="relative mx-auto max-w-5xl">
        ...
        <div className="grid gap-4 sm:grid-cols-3 sm:gap-6">
          {contactCards.map((card) => (
            <div key={card.id} className="group relative rounded-2xl border border-neutral-100 bg-white p-4 transition-all duration-300 hover:-translate-y-1 hover:border-emerald-300 hover:shadow-xl hover:shadow-emerald-500/15 sm:p-5 dark:border-neutral-800/50 dark:bg-neutral-900/80 dark:hover:border-emerald-500/50">
